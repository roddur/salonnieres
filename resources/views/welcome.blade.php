    ...
    <div class="container" style="width: 100%">
        <div class="row" style="background-color:black; color:white; padding-left:20px;">
            ...
            <ul class="nav navbar-nav navbar-right col-sm-2" style="margin-top: -20px;background-color: black;border-style: hidden;">
                ...
                @else
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" style="margin-top: -20px;background-color: black; color:white; border-style: hidden;">{{ Auth::user()->name }} <span class="caret"></span></a>
