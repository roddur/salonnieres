...
<pre> <font size="4"> 
              ...
              <b>Name</b>           : <?php echo e(Auth::user()->name); ?>          <a style="color:blue;"href="https://www.w3schools.com">Edit</a>
        
              <b>E-mail</b>         :  <?php echo e(Auth::user()->email); ?>       <a style="color:blue;"href="https://www.w3schools.com">Edit</a>
